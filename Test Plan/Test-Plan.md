...
You can find the detailed test run report [here](https://travis-ci.org/tarjmp/eventlab/). The Coverage Chart can be found for this project can be found on [codecov](https://codecov.io/gh/tarjmp/eventlab).
